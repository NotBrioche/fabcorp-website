...
<template>
  <div class="flex items-center justify-center gap-x-[8vw] max-lg:flex-col">
    <img
      v-if="!props.pos"
      :src="'images/' + props.project.image"
      class="xs:mb-4 mb-4 object-scale-down max-lg:order-0 md:h-100 md:hover:scale-105 lg:mb-0 lg:max-w-1/2"
    />
